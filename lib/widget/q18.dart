...
import 'package:tetsing/widget/q19.dart';

class QuestionPage18 extends StatefulWidget {
  @override
  _QuestionPageState createState() => _QuestionPageState();
}

class _QuestionPageState extends State<QuestionPage18> {
  double _progress = 0.72; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Are you interested in protecting data and ensuring information security??',
            ...
            Image.asset(
                'assets/images/q18.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage19(),
                    ),
                  );
