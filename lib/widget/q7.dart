...
import 'package:tetsing/widget/q8.dart';
...
class _QuestionPageState extends State<QuestionPage7> {
  double _progress = 0.28; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Are you detail-oriented and able to spot mistakes easily??',
            ...
            Image.asset(
                'assets/images/q7.png'), // Ensure the image path is correct
