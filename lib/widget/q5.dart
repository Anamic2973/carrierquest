...
import 'package:tetsing/widget/q6.dart';
...
class _QuestionPageState extends State<QuestionPage5> {
  double _progress = 0.20; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Are you interested in learning about laws, policies, or regulations??',
            ...
            Image.asset(
                'assets/images/q5.png'), // Ensure the image path is correct
