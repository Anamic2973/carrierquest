...
import 'package:tetsing/widget/q14.dart';

class QuestionPage13 extends StatefulWidget {
  @override
  _QuestionPageState createState() => _QuestionPageState();
}

class _QuestionPageState extends State<QuestionPage13> {
  double _progress = 0.52; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Do you have a creative mindset for solving problems??',
            ...
            Image.asset(
                'assets/images/q13.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage14(),
                    ),
                  );
