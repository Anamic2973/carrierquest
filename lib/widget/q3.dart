...
import 'package:tetsing/widget/q4.dart';
...
class _QuestionPageState extends State<QuestionPage3> {
  double _progress = 0.12; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Do you enjoy working with technology and online platforms??',
            ...
            Image.asset(
                'assets/images/q3.png'), // Ensure the image path is correct
