...
import 'package:tetsing/widget/q25.dart';

class QuestionPage24 extends StatefulWidget {
  @override
  _QuestionPageState createState() => _QuestionPageState();
}

class _QuestionPageState extends State<QuestionPage24> {
  double _progress = 0.96; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Are you good at organizing and managing your time effectively?',
            ...
            Image.asset(
                'assets/images/q24.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage25(),
                    ),
                  );
