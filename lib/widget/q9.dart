...
import 'package:tetsing/widget/q10.dart';
...
class _QuestionPageState extends State<QuestionPage9> {
  double _progress = 0.36; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Are you comfortable making decisions that may involve some level of risk??',
            ...
            Image.asset(
                'assets/images/q9.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage10(),
                    ),
                  );
