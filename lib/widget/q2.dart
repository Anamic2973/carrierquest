...
import 'package:tetsing/widget/q3.dart';
...
class _QuestionPageState extends State<QuestionPage2> {
  double _progress = 0.08; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Are you interested in analyzing data to make decisions??',
            ...
            Image.asset(
                'assets/images/q2.png'), // Ensure the image path is correct
