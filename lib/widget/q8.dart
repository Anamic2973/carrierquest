...
import 'package:tetsing/widget/q9.dart';
...
class _QuestionPageState extends State<QuestionPage8> {
  double _progress = 0.32; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Do you enjoy working in a fast-paced environment and handling multiple tasks?',
            ...
            Image.asset(
                'assets/images/q8.png'), // Ensure the image path is correct
