...
import 'package:tetsing/widget/q24.dart';

class QuestionPage23 extends StatefulWidget {
  @override
  _QuestionPageState createState() => _QuestionPageState();
}

class _QuestionPageState extends State<QuestionPage23> {
  double _progress = 0.92; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Do you enjoy working in a team to achieve common goals?',
            ...
            Image.asset(
                'assets/images/q23.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage24(),
                    ),
                  );
