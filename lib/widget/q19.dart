...
import 'package:tetsing/widget/q20.dart';

class QuestionPage19 extends StatefulWidget {
  @override
  _QuestionPageState createState() => _QuestionPageState();
}

class _QuestionPageState extends State<QuestionPage19> {
  double _progress = 0.76; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Do you like learning new languages or communicating with people from different ethinicity ?',
            ...
            Image.asset(
                'assets/images/q19.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage20(),
                    ),
                  );
