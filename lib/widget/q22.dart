...
import 'package:tetsing/widget/q23.dart';
...
class _QuestionPageState extends State<QuestionPage22> {
  double _progress = 0.88; // Initial progress (modify as needed)
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset(
                'assets/images/q22.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage23(),
                    ),
                  );
