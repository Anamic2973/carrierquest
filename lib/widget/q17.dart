...
import 'package:tetsing/widget/q18.dart';

class QuestionPage17 extends StatefulWidget {
  @override
  _QuestionPageState createState() => _QuestionPageState();
}

class _QuestionPageState extends State<QuestionPage17> {
  double _progress = 0.68; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Do you enjoy conducting experiments or scientific research?',
            ...
            Image.asset(
                'assets/images/q17.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage18(),
                    ),
                  );
