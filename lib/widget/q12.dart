...
import 'package:tetsing/widget/q13.dart';

class QuestionPage12 extends StatefulWidget {
  @override
  _QuestionPageState createState() => _QuestionPageState();
}

class _QuestionPageState extends State<QuestionPage12> {
  double _progress = 0.48; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Do you enjoy analyzing financial reports and market trends?',
            ...
            Image.asset(
                'assets/images/q12.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage13(),
                    ),
                  );
