...
import 'package:tetsing/widget/q17.dart';

class QuestionPage16 extends StatefulWidget {
  @override
  _QuestionPageState createState() => _QuestionPageState();
}

class _QuestionPageState extends State<QuestionPage16> {
  double _progress = 0.64; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Are you comfortable working with technology and complex systems?',
            ...
            Image.asset(
                'assets/images/q16.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => QuestionPage17(),
                    ),
                  );
