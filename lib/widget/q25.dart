...
import 'package:tetsing/widget/homepage.dart';

class QuestionPage25 extends StatefulWidget {
  @override
  _QuestionPageState createState() => _QuestionPageState();
}

class _QuestionPageState extends State<QuestionPage25> {
  double _progress = 0.1; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Do you enjoy finding solutions to challenging problems?',
            ...
            Image.asset(
                'assets/images/q25.png'), // Ensure the image path is correct
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CareerQuestApp(),
                    ),
                  );
