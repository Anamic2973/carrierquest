...
import 'package:tetsing/widget/q7.dart';
...
class _QuestionPageState extends State<QuestionPage6> {
  double _progress = 0.24; // Initial progress (modify as needed)
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: 350,
              child: Text(
                'Do you enjoy helping others and communicating with people??',
            ...
            Image.asset(
                'assets/images/q6.png'), // Ensure the image path is correct
